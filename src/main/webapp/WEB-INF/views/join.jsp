...
<div class="container">
    <div class="input-form-backgroud row">
      <div class="input-form col-md-12 mx-auto">
        ...
        <form class="validation-form"  action="/join/add" method="post" novalidate>
		...
		<c:if test="${error != null }">
          ...
          <div class="mb-3">
             ...
             <input type="text" class="form-control" id="username" name="username" placeholder="이름" value="" maxlength="20" required>
          ...
          <div class="mb-3" style="text-allign: center;">
             <div class="btn=group" data-toggle="buttons"></div>
               <label for="btn btn-primary active">
